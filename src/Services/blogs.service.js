...
export async function viewPostService(id, data) {
    let response = await axios.post(`${url}post/${id}/viewPost`, data, headerConfig)
    return response
}
...
// http://localhost:4000/api/v1/post/sendEmail/originalAuth/commentA
