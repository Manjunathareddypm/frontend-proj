...
const initialState = { allPosts: [], typeOfBlog: '', numberOfLikes: 0, numberOfviews: 0, typeOfBlogInDashBoard: 'All', authorName: localStorage.getItem('author'), forSearchType: "Home" ,relevanceType:"All"}
